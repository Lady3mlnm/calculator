...
function calculateFormat(data) {
    ...
    // (Вокруг знаков операторов размещаем ровно один пробел)
    data = data.replace(
    ...
    // (Вокруг знаков скобок размещаем ровно один пробел)
    // ('Некрасивость' этой строки в том, что в случае соседствующих
    //  скобок между ними получаются два пробела.)
